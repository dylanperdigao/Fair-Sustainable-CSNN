...
class Net_CNN_4conv(nn.Module, BaseNet_CNN):
    """
    Convolutional Neural Network with 4 convolutional layers and 1 fully connected layer.
...
if __name__ == "__main__":
    CNN_3H = [(1, 64, 2), (64, 128, 2), (128, 256, 2), (256, 512, 2), (512, 2)]
    TOPOLOGIES = [CNN_3H]
